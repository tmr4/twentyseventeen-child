...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( is_single() ) {
				// child theme mod: exclude byline on single post header
//				twentyseventeen_posted_on();
				echo '<span class="posted-on">' . twentyseventeen_time_link();
			} else {
				// child theme mod: add separator line between post listings
				echo '<div class="sum-sep"></div>';
	...
	<div class="entry-content">
		<?php
		// child theme mod: display excerpt only if not a single post
		if ( is_singular() ) {
			the_content(
//				sprintf(
